...
/**
 * The class that determines the vendor name in the database and allows to grab
...
public class VendorBroker {
    ...
    /**
     * Creates the communication between the database and the front-end
     * application for the vendor.
     */
    public VendorBroker() {
    ...
    /**
     * Takes the vendor name from the front-end and inserts it into the
     * database.
     *
